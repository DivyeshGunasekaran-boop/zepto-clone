...
const UPI_OPTIONS = [
  ...
  },
  {
    id: "phonepe",
    label: "PhonePe",
    logoUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/5/5f/PhonePe_logo.png/512px-PhonePe_logo.png",
    bgColor: "#5f259f"
  },
  {
    id: "paytm",
    label: "Paytm",
    logoUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/4/42/Paytm_logo.png/512px-Paytm_logo.png",
    bgColor: "#002970"
  },
  {
    id: "bhim",
...
function UpiLogoFallback({ appId }) {
  if (appId === "googlepay") {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { "aria-hidden": "true", viewBox: "0 0 48 48", width: "36", height: "36", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "path",
        {
          fill: "#4285F4",
  ...
  if (appId === "phonepe") {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { "aria-hidden": "true", viewBox: "0 0 48 48", width: "36", height: "36", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { width: "48", height: "48", rx: "12", fill: "#5f259f" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "text",
        {
          x: "24",
  ...
  if (appId === "paytm") {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { "aria-hidden": "true", viewBox: "0 0 48 48", width: "36", height: "36", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { width: "48", height: "48", rx: "4", fill: "#002970" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "text",
        {
          x: "24",
...
function UpiAppCard({ upi, isSelected, onSelect }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "button",
    {
      ...
      className: `relative flex flex-col items-center justify-center gap-2 p-3 rounded-2xl border-2 transition-all duration-200 shadow-sm hover:shadow-md active:scale-95 focus:outline-none ${isSelected ? "border-[#7B2FF7] bg-[#f5f0ff] shadow-[0_0_0_3px_rgba(123,47,247,0.15)]" : "border-gray-200 bg-white hover:border-[#c4a8ff] hover:bg-[#faf5ff]"}`,
      "data-ocid": `upi-option-${upi.id}`,
      "aria-pressed": isSelected,
      children: [
        isSelected && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-2 right-2 w-4 h-4 rounded-full bg-[#7B2FF7] flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "svg",
          {
            "aria-hidden": "true",
            viewBox: "0 0 10 10",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            ) : /* @__PURE__ */ jsxRuntimeExports.jsx(UpiLogoFallback, { appId: upi.id })
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "span",
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block w-full aspect-square overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                "img",
                {
                  ...
                  loading: "lazy",
                  onError: (e) => {
                    e.currentTarget.src = "https://images.unsplash.com/photo-1542838132-92c53300491e?w=120&q=80";
                  }
                }
              ) }),

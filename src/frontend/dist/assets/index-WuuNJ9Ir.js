...
const initialState = {
  items: [],
  // flat: {id, name, brand, category, price, image, weight, quantity}
  isCartOpen: false,
  isLoggedIn: false,
  user: null,
  // {name, phone}
  activeModal: null,
  // 'product' | 'payment' | 'success' | 'login' | 'map'
  modalData: null,
  orderTotal: 0
};
function cartReducer(state, action) {
  ...
  switch (action.type) {
      ...
      if (existing) {
        return {
          ...
          items: state.items.map(
            (i) => i.id === flat.id ? { ...i, quantity: i.quantity + 1 } : i
          )
        };
      }
    ...
    case "UPDATE_QUANTITY": {
      const id = ((_a2 = action.payload) == null ? void 0 : _a2.id) ?? action.productId;
      const qty = ((_b2 = action.payload) == null ? void 0 : _b2.qty) ?? action.quantity;
      if (qty <= 0) {
        return { ...state, items: state.items.filter((i) => i.id !== id) };
      }
      return {
...
function CartProvider({ children }) {
  const [state, dispatch] = reactExports.useReducer(cartReducer, initialState);
  reactExports.useEffect(() => {
    try {
      const stored = localStorage.getItem(STORAGE_KEY);
      if (stored) {
        const parsed = JSON.parse(stored);
        const items = Array.isArray(parsed) ? parsed.map((i) => {
          if (i.product) {
            return {
              id: i.product.id,
              name: i.product.name,
  ...
  const removeFromCart = reactExports.useCallback((productId) => {
  ...
  const toggleCart = reactExports.useCallback(() => {
    dispatch({ type: "TOGGLE_CART" });
  }, []);
  const closeCart = reactExports.useCallback(() => {
  ...
  const getItemQuantity = reactExports.useCallback(
    (productId) => {
      var _a2;
      return ((_a2 = state.items.find((i) => i.id === productId)) == null ? void 0 : _a2.quantity) ?? 0;
    },
    [state.items]
  );
  const contextValue = {
...
function CartSidebar({ onProceedToPayment }) {
  const {
    isOpen,
    closeCart,
    items,
  ...
  const handleCheckout = () => {
    onProceedToPayment == null ? void 0 : onProceedToPayment(grandTotal);
    closeCart();
  };
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "aside",
      {
        ...
        children: [
            ...
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2.5", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(ShoppingCart, { className: "w-5 h-5", style: { color: "#7B2FF7" } }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    ...
                    items.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs", style: { color: "#6b7280" }, children: [
                      totalItems,
                      " item",
                      totalItems !== 1 ? "s" : ""
                    ] })
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    ...
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx(X, { className: "w-5 h-5", style: { color: "#374151" } })
                  }
                )
              ]
            }
          ...
          items.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs font-bold", style: { color: "#0C831F" }, children: [
                  "⚡ Delivery in ",
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-extrabold", children: "10 minutes" })
                ] })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 overflow-y-auto px-4 py-3", children: items.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm mt-1.5", style: { color: "#6b7280" }, children: "Add items to get started" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
          ...
          ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-0", children: items.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs mt-0.5", style: { color: "#9ca3af" }, children: item.weight }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mt-1", children: [
                    ...
                    (item.originalPrice ?? 0) > item.price && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "p",
                      {
          ...
          items.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                  ...
                  "div",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                        ...
                        couponApplied ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex items-center justify-between", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "span",
                            {
                              className: "text-sm font-semibold",
                              style: { color: "#0C831F" },
                              children: "ZEPTO5 applied — 5% off!"
                            }
                          ),
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "button",
                      ...
                      couponError && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs mt-1 ml-6", style: { color: "#ef4444" }, children: couponError })
                    ]
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 pt-3 pb-2 space-y-2", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5 text-sm", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#374151" }, children: "Item Total" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-semibold", style: { color: "#111827" }, children: [
                        "₹",
                        totalPrice
                      ] })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#374151" }, children: "Delivery Fee" }),
                      isFreeDelivery ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsxs(
                          "span",
                          {
                            className: "text-xs line-through",
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-bold", style: { color: "#0C831F" }, children: "FREE" })
                      ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        "span",
                        {
                    ...
                    !isFreeDelivery && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "div",
                      {
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#374151" }, children: "Platform Fee" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-semibold", style: { color: "#111827" }, children: [
                        "₹",
                        PLATFORM_FEE
                      ] })
                    ] }),
                    couponApplied && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#0C831F" }, children: "Coupon Discount" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-bold", style: { color: "#0C831F" }, children: [
                        "−₹",
                        couponDiscount
                      ] })
                    ] })
                  ...
                  (discount > 0 || couponApplied) && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                    {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 pb-4 pt-1 flex flex-col gap-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "button",
                    {
                      type: "button",
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Proceed to Payment" }),
...
const CATEGORY_IMAGES = {
  ...
  laundry: "https://images.pexels.com/photos/5217939/pexels-photo-5217939.jpeg?auto=compress&cs=tinysrgb&w=200&h=200&fit=crop",
  cleaning: "https://images.pexels.com/photos/4239091/pexels-photo-4239091.jpeg?auto=compress&cs=tinysrgb&w=200&h=200&fit=crop",
  "rice-dal": "https://images.pexels.com/photos/4110251/pexels-photo-4110251.jpeg?auto=compress&cs=tinysrgb&w=200&h=200&fit=crop",
  "personal-hygiene": "https://images.pexels.com/photos/4465124/pexels-photo-4465124.jpeg?auto=compress&cs=tinysrgb&w=200&h=200&fit=crop",
  "hair-care": "https://images.pexels.com/photos/3993449/pexels-photo-3993449.jpeg?auto=compress&cs=tinysrgb&w=200&h=200&fit=crop",
  snacks: "https://images.pexels.com/photos/1583884/pexels-photo-1583884.jpeg?auto=compress&cs=tinysrgb&w=200&h=200&fit=crop",
  beverages: "https://images.pexels.com/photos/2983100/pexels-photo-2983100.jpeg?auto=compress&cs=tinysrgb&w=200&h=200&fit=crop",
  dairy: "https://images.pexels.com/photos/248412/pexels-photo-248412.jpeg?auto=compress&cs=tinysrgb&w=200&h=200&fit=crop",
  fruits: "https://images.pexels.com/photos/1132047/pexels-photo-1132047.jpeg?auto=compress&cs=tinysrgb&w=200&h=200&fit=crop"
};
function CategoryTabs({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "nav",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-[1400px] mx-auto px-3 md:px-5", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ref: scrollRef,
          className: "flex gap-2 overflow-x-auto py-2.5",
          style: { scrollbarWidth: "none", msOverflowStyle: "none" },
          children: categories2.map((cat) => {
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "leading-tight text-center line-clamp-2 max-w-[68px]", children: cat.name })
                ]
              },
              cat.id
            );
...
function Footer() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "footer",
    {
      ...
      "data-ocid": "footer",
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-[1400px] mx-auto px-6 pt-12 pb-10", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "h2",
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-7 gap-x-6 gap-y-8", children: CATEGORIES.map(({ heading, links }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-[1400px] mx-auto px-6 py-10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-4 gap-10", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Zap, { className: "w-6 h-6 text-primary fill-primary" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-2xl font-black text-white tracking-tight", children: "QuickCart" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
                ...
                children: "India's fastest grocery delivery. Fresh produce, daily essentials & more — delivered in 10 minutes."
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-3 mt-4", children: SOCIAL_LINKS.map(({ label, icon: Icon2, href }) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "a",
              {
                href,
                "aria-label": label,
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { className: "w-4 h-4 text-white" })
              },
              label
            )) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-sm font-bold text-white mb-4 tracking-wide uppercase", children: "Company" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2.5", children: COMPANY_LINKS.map(({ label, href }) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "a",
              {
                href,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-sm font-bold text-white mb-4 tracking-wide uppercase", children: "Legal" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2.5", children: LEGAL_LINKS.map(({ label, href }) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "a",
              {
                href,
                className: "footer-link",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-sm font-bold text-white mb-4 tracking-wide uppercase", children: "Download App" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
                className: "text-sm mb-4",
                style: { color: "rgba(255,255,255,0.5)" },
                children: "Get 10-minute delivery on the go."
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "a",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-bold text-white leading-tight", children: "Google Play" })
                  ] })
                ]
              }
            ),
              ...
              "a",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-bold text-white leading-tight", children: "App Store" })
                  ] })
                ]
              }
            )
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { borderTop: "1px solid rgba(255,255,255,0.08)" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-[1400px] mx-auto px-6 py-4 flex flex-col md:flex-row items-center justify-between gap-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs", style: { color: "rgba(255,255,255,0.35)" }, children: "🚀 10-min delivery · 🇮🇳 Made in India" })
        ] }) })
      ]
    }
  );
...
const categories = [
  {
    id: "all",
    name: "All",
    image: "https://images.pexels.com/photos/1132047/pexels-photo-1132047.jpeg?auto=compress&cs=tinysrgb&w=300&h=300&fit=crop"
  },
  {
    id: "dairy",
    name: "Dairy & Breakfast",
    image: "https://images.pexels.com/photos/248412/pexels-photo-248412.jpeg?auto=compress&cs=tinysrgb&w=300&h=300&fit=crop"
  },
  {
    id: "snacks",
    name: "Snacks & Munchies",
    image: "https://images.pexels.com/photos/1583884/pexels-photo-1583884.jpeg?auto=compress&cs=tinysrgb&w=300&h=300&fit=crop"
  },
  {
    id: "beverages",
    name: "Beverages",
    image: "https://images.pexels.com/photos/2983100/pexels-photo-2983100.jpeg?auto=compress&cs=tinysrgb&w=300&h=300&fit=crop"
  },
  {
    id: "fruits",
    name: "Fresh Fruits",
  ...
  },
  {
    id: "laundry",
    name: "Laundry Care",
    image: "https://images.pexels.com/photos/5217939/pexels-photo-5217939.jpeg?auto=compress&cs=tinysrgb&w=300&h=300&fit=crop"
  },
  {
    id: "cleaning",
  ...
  },
  {
    id: "hair-care",
    name: "Hair Care",
    image: "https://images.pexels.com/photos/3993449/pexels-photo-3993449.jpeg?auto=compress&cs=tinysrgb&w=300&h=300&fit=crop"
  },
  {
    id: "personal-hygiene",
...
const products = [
  // ─── DAIRY (14 products) ────────────────────────────────────────────────────
  {
    ...
    image: "https://images.pexels.com/photos/236010/pexels-photo-236010.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop",
    description: "Amul Taaza Toned Milk is pasteurised and homogenised for consistent quality. With 3% fat content, ideal for drinking, cooking, and making dairy products.",
    rating: 4.5,
    reviewCount: 18200,
    inStock: true
  },
  {
    ...
    description: "Mother Dairy Toned Milk is sourced from local dairy farmers and processed to ensure freshness and quality. Nutritious and delicious for the whole family.",
    rating: 4.4,
    reviewCount: 10320,
    inStock: true
  },
  {
    ...
    image: "https://images.pexels.com/photos/1435706/pexels-photo-1435706.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop",
    description: "Amul Gold Full Cream Milk contains 6% fat for a rich, creamy taste. Perfect for making thick kheer, coffee, and full-flavoured dairy-based desserts.",
    rating: 4.6,
    reviewCount: 12400,
    inStock: true
  },
  {
    ...
    image: "https://images.pexels.com/photos/531334/pexels-photo-531334.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop",
    description: "Amul Pasteurised Butter is made from fresh cream for a rich, creamy flavour. Perfect for spreading, cooking, baking, and adding richness to your favourite dishes.",
    rating: 4.7,
    reviewCount: 24100,
    inStock: true
  },
  {
    ...
    image: "https://images.pexels.com/photos/6544375/pexels-photo-6544375.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop",
    description: "Amul Fresh Paneer is made from fresh cow milk for a soft, spongy texture. Rich in protein and calcium, the cornerstone ingredient in countless beloved Indian dishes.",
    rating: 4.5,
    reviewCount: 11200,
    inStock: true
  },
  {
    ...
    description: "Britannia Cheese Slices are made from processed cow milk cheese for consistent quality and taste. Perfectly portioned slices that melt beautifully for sandwiches and burgers.",
    rating: 4.5,
    reviewCount: 8720,
    inStock: true
  },
  {
    ...
    image: "https://images.pexels.com/photos/1105702/pexels-photo-1105702.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop",
    description: "Mother Dairy Full Cream Curd is made from fresh pasteurised full cream milk. Thick and creamy with a mildly tangy taste, perfect for raita, lassi, or eating plain.",
    rating: 4.4,
    reviewCount: 9870,
    inStock: true
  },
  {
    ...
    image: "https://images.pexels.com/photos/373882/pexels-photo-373882.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop",
    description: "Amul Greek Yogurt is strained to give a thick, creamy texture with higher protein content. Made from whole milk, it's a nutritious option for a healthy, filling snack.",
    rating: 4.4,
    reviewCount: 4320,
    inStock: true
  },
  {
    ...
    image: "https://images.pexels.com/photos/4110252/pexels-photo-4110252.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop",
    description: "Britannia Milkman Pure Ghee is made from fresh cream using a traditional slow-cooking method. Rich aroma and golden colour with authentic desi ghee taste.",
    rating: 4.5,
    reviewCount: 5640,
    inStock: true
  },
  {
    ...
    image: "https://images.pexels.com/photos/1362534/pexels-photo-1362534.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop",
    description: "Kwality Wall's Cornetto Choco Brownie is a cone ice cream with chocolate sauce, brownie pieces, and almonds. A complete indulgent dessert experience in every bite.",
    rating: 4.6,
    reviewCount: 9870,
    inStock: true
  },
  {
    ...
    image: "https://images.pexels.com/photos/1352281/pexels-photo-1352281.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop",
    description: "Amul Real Ice Cream Vanilla is made with real milk and Bourbon vanilla beans for a rich, creamy, authentic flavour. A classic dessert loved by the whole family.",
    rating: 4.5,
    reviewCount: 8720,
    inStock: true
  },
  {
    ...
    image: "https://images.pexels.com/photos/3872373/pexels-photo-3872373.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop",
    description: "Nestlé MILKMAID Sweetened Condensed Milk is made with whole milk and sugar for a thick, creamy sweetness. The ultimate ingredient for desserts, sweets, and baking.",
    rating: 4.6,
    reviewCount: 5640,
    inStock: true
  },
  {
    ...
    image: "https://images.pexels.com/photos/4397923/pexels-photo-4397923.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop",
    description: "Amul Mast Dahi is thick, creamy, and freshly made from pasteurised milk with live cultures. The perfect accompaniment to any meal or the base for lassi and raita.",
    rating: 4.4,
    reviewCount: 7650,
    inStock: true
  },
  {
    ...
    image: "https://images.pexels.com/photos/3735220/pexels-photo-3735220.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop",
    description: "Amul Taaza UHT Toned Milk in Tetra Pak has a 180-day shelf life without refrigeration until opened. Convenient and nutritious for travel and pantry stocking.",
    rating: 4.4,
    reviewCount: 9870,
    inStock: true
  },
  // ─── SNACKS (15 products) ───────────────────────────────────────────────────
  {
    ...
    image: "https://images.pexels.com/photos/1583884/pexels-photo-1583884.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop",
    description: "Lay's Classic Salted Potato Chips are wafer-thin and perfectly salted for the ultimate snacking experience. Made from farm-fresh potatoes for authentic taste in every bite.",
    rating: 4.4,
    reviewCount: 23100,
    inStock: true
  },
  {
    ...
    image: "https://images.pexels.com/photos/5741059/pexels-photo-5741059.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop",
    description: "Kurkure Masala Munch is an irresistible crunchy snack made from rice, corn, and gram flour. Its unique twisted shape is flavoured with real spices for the perfect masala kick.",
    rating: 4.3,
    reviewCount: 15420,
    inStock: true
  },
  {
    ...
    image: "https://images.pexels.com/photos/4518615/pexels-photo-4518615.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop",
    description: "Doritos Nacho Cheese Tortilla Chips are boldly flavoured corn chips coated in real cheese seasoning. Triangular, crunchy, and irresistible — perfect for dipping.",
    rating: 4.4,
    reviewCount: 4320,
    inStock: true
  },
  {
    ...
    image: "https://images.pexels.com/photos/5060443/pexels-photo-5060443.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop",
    description: "Pringles Original Flavour Chips are uniformly shaped, perfectly seasoned potato crisps stacked in the iconic tube. Each crisp delivers the same satisfying crunch.",
    rating: 4.5,
    reviewCount: 7630,
    inStock: true
  },
  {
    ...
    image: "https://images.pexels.com/photos/9609847/pexels-photo-9609847.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop",
    description: "Haldiram's Bhujia Sev is a spicy, crunchy Indian snack made with moth bean flour and spices. A classic tea-time favourite enjoyed across India for generations.",
    rating: 4.5,
    reviewCount: 14200,
    inStock: true
  },
  {
    ...
    image: "https://images.pexels.com/photos/9609833/pexels-photo-9609833.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop",
    description: "Haldiram's Aloo Bhujia Sev is a classic Indian namkeen made with potatoes and chickpea flour. Its signature blend of spices makes it the perfect tea-time companion.",
    rating: 4.5,
    reviewCount: 12300,
    inStock: true
  },
  {
    ...
    image: "https://images.pexels.com/photos/1279330/pexels-photo-1279330.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop",
    description: "Maggi 2-Minute Masala Noodles are the quick and delicious snack loved by millions. Made with real vegetables and authentic spices, ready in just 2 minutes.",
    rating: 4.6,
    reviewCount: 38900,
    inStock: true
  },
  {
    ...
    image: "https://images.pexels.com/photos/890515/pexels-photo-890515.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop",
    description: "Oreo Chocolate Sandwich Biscuits feature two crispy chocolate wafers with a sweet cream filling. Enjoy by dunking in milk or twisting apart for the iconic Oreo experience.",
    rating: 4.6,
    reviewCount: 18900,
    inStock: true
  },
  {
    ...
    image: "https://images.pexels.com/photos/6438751/pexels-photo-6438751.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop",
    description: "Parle-G Original Glucose Biscuits are an iconic Indian treat enjoyed for generations. Made with wheat flour, sugar, and milk solids for a wholesome, delicious snack.",
    rating: 4.7,
    reviewCount: 45300,
    inStock: true
  },
  {
    ...
    description: "Cadbury Dairy Milk Silk is extra smooth with a silkier texture than regular Dairy Milk. Made with milk chocolate for a premium, indulgent chocolate experience.",
    rating: 4.8,
    reviewCount: 32400,
    inStock: true
  },
  {
    ...
    image: "https://images.pexels.com/photos/3026804/pexels-photo-3026804.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop",
    description: "KitKat 4 Finger is the world-famous chocolate-covered wafer bar. Each crispy wafer finger is covered in smooth milk chocolate for a perfect break-time indulgence.",
    rating: 4.6,
    reviewCount: 28100,
    inStock: true
  },
  {
    ...
    image: "https://images.pexels.com/photos/5765/pexels-photo-5765.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop",
    description: "Britannia Bourbon Biscuits are crunchy chocolate biscuits sandwiched with a chocolate cream filling. A classic Indian biscuit enjoyed with tea or coffee for decades.",
    rating: 4.3,
    reviewCount: 9870,
    inStock: true
  },
  {
    ...
    image: "https://images.pexels.com/photos/1775283/pexels-photo-1775283.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop",
    description: "Britannia Good Day Cashew Cookies are rich, buttery biscuits packed with whole cashew pieces. A delightful treat that pairs perfectly with tea or coffee.",
    rating: 4.4,
    reviewCount: 9870,
    inStock: true
  },
  {
    ...
    image: "https://images.pexels.com/photos/4109899/pexels-photo-4109899.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop",
    description: "Nestlé Munch is a crispy wafer chocolate bar that delivers a satisfying crunch. Coated in smooth milk chocolate, it's the perfect on-the-go chocolate snack.",
    rating: 4.4,
    reviewCount: 19500,
    inStock: true
  },
  {
    ...
    image: "https://images.pexels.com/photos/1448735/pexels-photo-1448735.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop",
    description: "Parle Monaco Salted Biscuits are light, crispy biscuits with a classic salted taste. Made with fine flour and a generous topping of salt, perfect with tea or as a snack.",
    rating: 4.3,
    reviewCount: 7650,
    inStock: true
  },
  // ─── BEVERAGES (14 products) ────────────────────────────────────────────────
  {
    ...
    image: "https://images.pexels.com/photos/2983100/pexels-photo-2983100.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop",
    description: "Coca-Cola Original Taste is the world's most loved sparkling beverage. The iconic blend of flavours in every refreshing fizzy sip makes it the perfect companion for any meal.",
    rating: 4.5,
    reviewCount: 34200,
    inStock: true
  },
  {
    ...
    image: "https://images.pexels.com/photos/50593/coca-cola-cold-drink-soft-drink-coke-50593.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop",
    description: "Pepsi Cola is a refreshing carbonated soft drink with the bold, iconic Pepsi flavour. Enjoy it ice-cold for maximum refreshment with meals or on its own.",
    rating: 4.3,
    reviewCount: 18900,
    inStock: true
  },
  {
    ...
    image: "https://images.pexels.com/photos/338713/pexels-photo-338713.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop",
    description: "Sprite Lime Flavour is a crisp, clear sparkling beverage with a refreshing lemon-lime taste. Its clean, light flavour makes it the perfect thirst-quencher on a hot day.",
    rating: 4.3,
    reviewCount: 12100,
    inStock: true
  },
  {
    ...
    image: "https://images.pexels.com/photos/5947041/pexels-photo-5947041.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop",
    description: "Red Bull Energy Drink contains caffeine, taurine, B vitamins, and sugars for a vitalising effect. Proven to improve performance, concentration, and reaction speed.",
    rating: 4.4,
    reviewCount: 4530,
    inStock: true
  },
  {
    ...
    image: "https://images.pexels.com/photos/96974/pexels-photo-96974.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop",
    description: "Tropicana Orange 100% Juice is squeezed from the finest oranges with no added sugar or preservatives. Every sip is packed with natural Vitamin C for a refreshing, healthy start.",
    rating: 4.4,
    reviewCount: 8720,
    inStock: true
  },
  {
    ...
    image: "https://images.pexels.com/photos/3625372/pexels-photo-3625372.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop",
    description: "Real Fruit Mango Juice is made from handpicked Alphonso mangoes for an authentic, rich mango taste. No artificial colours, flavours, or preservatives — just pure mango.",
    rating: 4.4,
    reviewCount: 6540,
    inStock: true
  },
  {
    ...
    image: "https://images.pexels.com/photos/4551832/pexels-photo-4551832.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop",
    description: "Paper Boat Aamras brings back the thick, sweet taste of raw mango. Made with real mango pulp and a hint of cardamom — a seasonal favourite in every sip.",
    rating: 4.3,
    reviewCount: 6540,
    inStock: true
  },
  {
    ...
    description: "Nescafé Classic Instant Coffee delivers the rich, roasted taste of real coffee in seconds. Made from 100% pure, high-quality coffee beans for a consistently great cup.",
    rating: 4.4,
    reviewCount: 21340,
    inStock: true
  },
  {
    ...
    image: "https://images.pexels.com/photos/374885/pexels-photo-374885.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop",
    description: "Bru Gold Freeze Dried Coffee is made from the finest Arabica and Robusta beans. The freeze-drying process preserves the rich aroma and full-bodied flavour.",
    rating: 4.5,
    reviewCount: 9870,
    inStock: true
  },
  {
    ...
    image: "https://images.pexels.com/photos/1417945/pexels-photo-1417945.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop",
    description: "Lipton Pure Green Tea is made from the finest young tea leaves for a light, refreshing taste. Rich in antioxidants, it's the healthy choice for daily wellness.",
    rating: 4.3,
    reviewCount: 7650,
    inStock: true
  },
  {
    ...
    image: "https://images.pexels.com/photos/1493080/pexels-photo-1493080.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop",
    description: "Tata Tea Gold is a special blend of long-leaf teas and whole tea leaves from premium gardens. Brews into a perfectly balanced cup with a rich colour and invigorating taste.",
    rating: 4.5,
    reviewCount: 12300,
    inStock: true
  },
  {
    ...
    image: "https://images.pexels.com/photos/3625375/pexels-photo-3625375.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop",
    description: "Horlicks Original Health Drink is packed with 23 vital nutrients to support growth and immunity. The classic malted wheat and milk drink loved by families for generations.",
    rating: 4.4,
    reviewCount: 8910,
    inStock: true
  },
  {
    ...
    image: "https://images.pexels.com/photos/3737593/pexels-photo-3737593.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop",
    description: "Maaza Mango Fruit Drink is made with real mango pulp for a thick, luscious mango taste. A beloved Indian beverage that captures the essence of summer mangoes.",
    rating: 4.5,
    reviewCount: 15600,
    inStock: true
  },
  {
    ...
    image: "https://images.pexels.com/photos/5947035/pexels-photo-5947035.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop",
    description: "Minute Maid Pulpy Orange Juice with real orange pulp delivers a refreshing taste and Vitamin C. Contains natural orange pulp pieces for an authentic juice experience.",
    rating: 4.2,
    reviewCount: 3980,
    inStock: true
  },
  // ─── FRUITS (14 products) ───────────────────────────────────────────────────
  {
    ...
    image: "https://images.pexels.com/photos/1093038/pexels-photo-1093038.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop",
    description: "Fresh Elaichi Bananas are small, sweet, and aromatic — a prized variety known for their superior taste. Naturally ripened, rich in potassium and natural energy.",
    rating: 4.4,
    reviewCount: 3210,
    inStock: true
  },
  {
    ...
    description: "Himachal Apples are grown in the cool mountain valleys of Himachal Pradesh. These crisp, juicy apples have a perfect balance of sweetness and tartness.",
    rating: 4.5,
    reviewCount: 5430,
    inStock: true
  },
  {
    ...
    image: "https://images.pexels.com/photos/918643/pexels-photo-918643.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop",
    description: "Alphonso Mangoes are the undisputed king of mangoes, known for their rich, creamy, tender pulp and sweet, distinct aroma. Sourced directly from Ratnagiri farms.",
    rating: 4.8,
    reviewCount: 9870,
    inStock: true
  },
  {
    ...
    image: "https://images.pexels.com/photos/161559/background-bitter-citrus-food-161559.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop",
    description: "Nagpur Mandarin Oranges are renowned for their deep orange colour, thin skin, and sweet, juicy segments. Known as the 'Orange City' variety for exceptional quality.",
    rating: 4.3,
    reviewCount: 3210,
    inStock: true
  },
  {
    ...
    description: "Seedless Watermelon is 92% water with a refreshingly sweet red flesh. A perfect summer fruit packed with lycopene, Vitamin C, and hydration in every juicy bite.",
    rating: 4.5,
    reviewCount: 6540,
    inStock: true
  },
  {
    ...
    image: "https://images.pexels.com/photos/760281/pexels-photo-760281.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop",
    description: "Green Seedless Grapes are plump, juicy, and perfectly sweet with a refreshing crunch. A convenient, healthy snack that's loved by adults and kids alike.",
    rating: 4.4,
    reviewCount: 4320,
    inStock: true
  },
  {
    ...
    image: "https://images.pexels.com/photos/69794/pomegranate-exotic-fruit-red-69794.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop",
    description: "Fresh Pomegranate is packed with juicy, ruby-red arils bursting with antioxidants. Rich in Vitamin C and fibre, it's a nutritional powerhouse and a delicious natural treat.",
    rating: 4.3,
    reviewCount: 2100,
    inStock: true
  },
  {
    ...
    image: "https://images.pexels.com/photos/952354/pexels-photo-952354.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop",
    description: "Fresh Ripe Papaya is golden-orange in colour with a sweet, musky flavour. Rich in papain enzyme, Vitamin A, and antioxidants — excellent for digestion and skin health.",
    rating: 4.2,
    reviewCount: 1540,
    inStock: true
  },
  {
    ...
    description: "Golden Pineapple is sweet and aromatic with a rich tropical flavour. Naturally ripe and juicy, it's perfect for eating fresh, juicing, or adding to desserts and salads.",
    rating: 4.3,
    reviewCount: 2100,
    inStock: true
  },
  {
    ...
    image: "https://images.pexels.com/photos/89778/strawberries-frisch-ripe-sweet-89778.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop",
    description: "Fresh Strawberries are hand-picked at peak ripeness for maximum sweetness and flavour. Rich in Vitamin C and antioxidants — delicious fresh, in smoothies, or with cream.",
    rating: 4.6,
    reviewCount: 3120,
    inStock: true
  },
  {
    ...
    image: "https://images.pexels.com/photos/51312/kiwi-fruit-vitamins-healthy-eating-51312.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop",
    description: "Gold Kiwi has a smooth yellow-green flesh that is sweeter and less tangy than green kiwi. Exceptionally high in Vitamin C and loaded with antioxidants for immune support.",
    rating: 4.5,
    reviewCount: 1870,
    inStock: true
  },
  {
    ...
    description: "Fresh White Guava has a mild, sweet flavour with a crisp, firm texture. Contains 4x more Vitamin C than an orange and is rich in dietary fibre for good digestive health.",
    rating: 4.3,
    reviewCount: 1890,
    inStock: true
  },
  {
    ...
    weight: "1 kg",
    // Green/yellow pears
    image: "https://images.pexels.com/photos/568471/pexels-photo-568471.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop",
    description: "Fresh Green Pears are naturally sweet with a slightly gritty but juicy texture. Rich in fibre and antioxidants, they make a refreshing snack or beautiful addition to salads.",
    rating: 4.2,
    reviewCount: 1230,
    inStock: true
  },
  {
    ...
    image: "https://images.pexels.com/photos/4051285/pexels-photo-4051285.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop",
    description: "Sweet Lime Mosambi has a mild, sweet citrus flavour with a refreshing, clean taste. Excellent for juicing, it's a natural electrolyte drink rich in Vitamin C.",
    rating: 4.3,
    reviewCount: 1540,
    inStock: true
  },
  // ─── LAUNDRY (10 products) ──────────────────────────────────────────────────
  {
    ...
    image: "https://images.pexels.com/photos/5217939/pexels-photo-5217939.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop",
    description: "Surf Excel Easy Wash Detergent Powder removes tough stains easily even in less water. Its advanced formula penetrates deep into fabric fibres to lift out stains.",
    rating: 4.5,
    reviewCount: 2847,
    inStock: true
  },
  {
    ...
    image: "https://images.pexels.com/photos/6316065/pexels-photo-6316065.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop",
    description: "Ariel Matic is specially designed for front-load washing machines. Its Actilift technology removes up to 30 tough stains in one wash, even at 30°C cold water.",
    rating: 4.6,
    reviewCount: 3210,
    inStock: true
  },
  {
    ...
    image: "https://images.pexels.com/photos/5591664/pexels-photo-5591664.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop",
    description: "Rin Advanced Detergent Powder gives you brilliant whiteness and freshness with every wash. Specially formulated to remove stubborn stains while keeping whites dazzlingly bright.",
    rating: 4.3,
    reviewCount: 1956,
    inStock: true
  },
  {
    ...
    description: "Comfort Fabric Conditioner adds a long-lasting fragrance and softness to your clothes. Its micro-conditioner formula reduces wrinkles and makes ironing easier.",
    rating: 4.4,
    reviewCount: 1102,
    inStock: true
  },
  {
    ...
    description: "Tide Plus Detergent removes stains and keeps clothes bright. Its dual-action formula cleans tough stains while leaving clothes smelling fresh and clean.",
    rating: 4.2,
    reviewCount: 876,
    inStock: true
  },
  {
    ...
    image: "https://images.pexels.com/photos/5591467/pexels-photo-5591467.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop",
    description: "Henko Stain Care Detergent Powder is powered by intelligent stain-fighting technology that targets and removes various types of stains including oil, grease, and food stains.",
    rating: 4.1,
    reviewCount: 543,
    inStock: true
  },
  {
    ...
    image: "https://images.pexels.com/photos/4108715/pexels-photo-4108715.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop",
    description: "Ezee Liquid Detergent is specially formulated for delicate fabrics including woollens and silks. Its gentle formula cleans effectively without damaging fabric fibres.",
    rating: 4,
    reviewCount: 432,
    inStock: true
  },
  {
    ...
    description: "Surf Excel Detergent Bar makes scrubbing away stubborn stains quick and easy. Its powerful cleaning formula works effectively on collar and cuff stains.",
    rating: 4.3,
    reviewCount: 2100,
    inStock: true
  },
  {
    ...
    image: "https://images.pexels.com/photos/4107277/pexels-photo-4107277.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop",
    description: "Vim Dishwash Liquid Gel with the power of lemon cuts through grease and leaves dishes sparkling clean. Its concentrated formula gives you more washes per bottle.",
    rating: 4.4,
    reviewCount: 3400,
    inStock: true
  },
  {
    ...
    image: "https://images.pexels.com/photos/4108813/pexels-photo-4108813.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop",
    description: "Pril Active Lime Dishwash Liquid effortlessly removes grease and grime from dishes, pots, and pans. Enriched with lime extracts for a fresh, clean finish.",
    rating: 4.2,
    reviewCount: 1876,
    inStock: true
  },
  // ─── CLEANING (10 products) ─────────────────────────────────────────────────
  {
    ...
    description: "Dettol Liquid Disinfectant kills 99.9% of germs and bacteria. Use diluted for household cleaning, laundry, or as a personal antiseptic for cuts and wounds.",
    rating: 4.7,
    reviewCount: 5621,
    inStock: true
  },
  {
    ...
    image: "https://images.pexels.com/photos/6195121/pexels-photo-6195121.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop",
    description: "Harpic Power Plus destroys tough limescale and kills 99.9% of germs under the rim. Its thick formula clings to the bowl for superior cleaning action.",
    rating: 4.5,
    reviewCount: 3201,
    inStock: true
  },
  {
    ...
    image: "https://images.pexels.com/photos/4108715/pexels-photo-4108715.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop&seed=2",
    description: "Colin Glass & Surface Cleaner leaves glass, mirrors, and chrome surfaces crystal clear without streaks. Its fast-evaporating formula removes fingerprints and smudges instantly.",
    rating: 4.4,
    reviewCount: 1890,
    inStock: true
  },
  {
    ...
    image: "https://images.pexels.com/photos/4107104/pexels-photo-4107104.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop",
    description: "Lizol Floor Cleaner disinfects and cleans all types of floor surfaces leaving a fresh citrus fragrance. Kills 99.9% of germs while cleaning effectively.",
    rating: 4.5,
    reviewCount: 4120,
    inStock: true
  },
  {
    ...
    image: "https://images.pexels.com/photos/4107166/pexels-photo-4107166.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop",
    description: "Scotch-Brite Heavy Duty Scrub Pad tackles the toughest burnt-on food and grease. The fibres are interlocked for extra scrubbing power without scratching surfaces.",
    rating: 4.3,
    reviewCount: 2340,
    inStock: true
  },
  {
    ...
    image: "https://images.pexels.com/photos/5217944/pexels-photo-5217944.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop",
    description: "Domex Ultra Thick Bleach kills germs and removes tough stains from toilet bowls and bathroom surfaces. Its thick formula clings for longer contact time.",
    rating: 4.2,
    reviewCount: 980,
    inStock: true
  },
  {
    ...
    description: "Febreze Air Freshener eliminates odours rather than just masking them. The calming lavender fragrance freshens the air and leaves a long-lasting pleasant scent.",
    rating: 4.4,
    reviewCount: 654,
    inStock: true
  },
  {
    ...
    image: "https://images.pexels.com/photos/4108797/pexels-photo-4108797.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop",
    description: "Good Knight Advanced Mosquito Refill provides up to 45 nights of protection. Its advanced formula creates an invisible barrier against mosquitoes for a safe, peaceful night.",
    rating: 4.6,
    reviewCount: 3987,
    inStock: true
  },
  {
    ...
    image: "https://images.pexels.com/photos/4108786/pexels-photo-4108786.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop",
    description: "HIT Cockroach Killer Spray provides instant kill and long-lasting protection against cockroaches. Its deep-reach nozzle targets hidden areas where pests breed.",
    rating: 4.3,
    reviewCount: 2210,
    inStock: true
  },
  {
    ...
    image: "https://images.pexels.com/photos/4239090/pexels-photo-4239090.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop",
    description: "Mortein Insect Killer Spray kills flies, mosquitoes, and cockroaches on contact. Its residual action keeps insects away for up to 4 weeks after application.",
    rating: 4.4,
    reviewCount: 1760,
    inStock: true
  },
  // ─── HAIR CARE (10 products) ────────────────────────────────────────────────
  {
    ...
    description: "Head & Shoulders Classic Clean Shampoo gives you beautiful, dandruff-free hair from the first wash. Its ZPT formula fights dandruff and keeps your scalp healthy.",
    rating: 4.5,
    reviewCount: 8940,
    inStock: true
  },
  {
    ...
    image: "https://images.pexels.com/photos/3993445/pexels-photo-3993445.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop",
    description: "Pantene Smooth & Silky Shampoo with Pro-V formula smooths and nourishes each hair strand. Tames frizz and adds brilliant shine for silky, smooth hair all day long.",
    rating: 4.4,
    reviewCount: 4320,
    inStock: true
  },
  {
    ...
    image: "https://images.pexels.com/photos/4046316/pexels-photo-4046316.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop",
    description: "Dove Intense Repair Shampoo with Keratin Actives penetrates deep inside each strand to repair damage from the first wash. Leaves hair visibly healthier and more resilient.",
    rating: 4.4,
    reviewCount: 5320,
    inStock: true
  },
  {
    ...
    image: "https://images.pexels.com/photos/3993453/pexels-photo-3993453.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop",
    description: "Sunsilk Black Shine Shampoo with Amla flower extract brings back your hair's natural black shine. Strengthens hair to reduce breakage and keeps it glossy and healthy.",
    rating: 4.3,
    reviewCount: 3210,
    inStock: true
  },
  {
    ...
    description: "Indulekha Bringha Hair Oil is an Ayurvedic formula with Bringharaj, Coconut Oil, and other herbs. Clinical tests show it reduces hair fall and promotes new hair growth.",
    rating: 4.6,
    reviewCount: 9870,
    inStock: true
  },
  {
    ...
    image: "https://images.pexels.com/photos/725998/pexels-photo-725998.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop",
    description: "Parachute Advansed Coconut Hair Oil nourishes and strengthens hair from root to tip. 100% pure coconut oil enriched with essential vitamins for lustrous, healthy hair.",
    rating: 4.5,
    reviewCount: 11200,
    inStock: true
  },
  {
    ...
    image: "https://images.pexels.com/photos/4465125/pexels-photo-4465125.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop",
    description: "L'Oréal Total Repair 5 Shampoo targets 5 hair problems: damage, dryness, dullness, roughness, and breakage. Strengthens hair from root to tip for visibly healthier hair.",
    rating: 4.4,
    reviewCount: 6540,
    inStock: true
  },
  {
    ...
    image: "https://images.pexels.com/photos/4465127/pexels-photo-4465127.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop",
    description: "Vatika Enriched Coconut Hair Oil is fortified with Henna, Amla, and Lemon for conditioning, strengthening, and nourishment. Reduces dandruff and promotes healthy hair growth.",
    rating: 4.3,
    reviewCount: 4230,
    inStock: true
  },
  {
    ...
    image: "https://images.pexels.com/photos/3993460/pexels-photo-3993460.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop",
    description: "TRESemme Keratin Smooth Shampoo with BIOTIN infuses damaged hair with strengthening proteins. Tames frizzy, unmanageable hair for a silky, smooth finish.",
    rating: 4.3,
    reviewCount: 1980,
    inStock: true
  },
  {
    ...
    image: "https://images.pexels.com/photos/4046320/pexels-photo-4046320.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop",
    description: "Biotique Bio Kelp Shampoo stimulates hair follicles to encourage new hair growth. Powered by Ocean Kelp and Centella Asiatica, this Ayurvedic formula reduces hair thinning.",
    rating: 4.2,
    reviewCount: 1340,
    inStock: true
  },
  // ─── PERSONAL HYGIENE (10 products) ────────────────────────────────────────
  {
    ...
    description: "Dettol Original Soap Bar protects you from 100 illness-causing germs with its proven antibacterial formula. Leaves skin feeling clean, fresh, and well-protected.",
    rating: 4.6,
    reviewCount: 7830,
    inStock: true
  },
  {
    ...
    image: "https://images.pexels.com/photos/3321589/pexels-photo-3321589.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop",
    description: "Dove Beauty Cream Bar is made with 1/4 moisturising cream that gently cleanses your skin. It doesn't dry skin out like ordinary soap, leaving it soft and smooth.",
    rating: 4.5,
    reviewCount: 5640,
    inStock: true
  },
  {
    ...
    image: "https://images.pexels.com/photos/4239143/pexels-photo-4239143.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop",
    description: "Lifebuoy Total 10 Handwash fights 10 infection-causing germs including H1N1 influenza virus. Its Active5 formula provides thorough protection with every wash.",
    rating: 4.4,
    reviewCount: 4530,
    inStock: true
  },
  {
    ...
    description: "Himalaya Purifying Neem Face Wash with Neem and Turmeric purifies skin and prevents pimples. Removes dirt, oil, and impurities for a fresh, clean complexion.",
    rating: 4.4,
    reviewCount: 9870,
    inStock: true
  },
  {
    ...
    image: "https://images.pexels.com/photos/3764530/pexels-photo-3764530.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop",
    description: "Colgate MaxFresh Toothpaste with cooling crystals and Cool Mint flavour gives you long-lasting freshness. Fights cavities and provides a clean, refreshing mouth feel.",
    rating: 4.5,
    reviewCount: 9210,
    inStock: true
  },
  {
    ...
    image: "https://images.pexels.com/photos/1559400/pexels-photo-1559400.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop",
    description: "Oral-B Pro Expert Toothbrush features cross-action bristles that reach between teeth and along the gumline. Soft, rounded bristle tips are gentle on teeth and gums.",
    rating: 4.4,
    reviewCount: 3450,
    inStock: true
  },
  {
    ...
    weight: "1 unit",
    // Shaving razor blade
    image: "https://images.pexels.com/photos/3992876/pexels-photo-3992876.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop",
    description: "Gillette Mach3 Turbo features 3 advanced anti-friction blades for a smooth, close shave with fewer strokes. The Turbo technology provides superior comfort and skin protection.",
    rating: 4.6,
    reviewCount: 5120,
    inStock: true
  },
  {
    ...
    image: "https://images.pexels.com/photos/3785147/pexels-photo-3785147.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop",
    description: "Nivea Soft Moisturising Cream with Vitamin E and Jojoba Oil provides instant moisturisation for face, body, and hands. Lightweight, non-greasy formula absorbs quickly.",
    rating: 4.5,
    reviewCount: 7230,
    inStock: true
  },
  {
    ...
    image: "https://images.pexels.com/photos/4465826/pexels-photo-4465826.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop",
    description: "Whisper Ultra Clean Sanitary Pads feature Feather Soft cover that stays up to 2x softer even when wet. Its unique design provides leak-lock protection for confident movement.",
    rating: 4.6,
    reviewCount: 4890,
    inStock: true
  },
  {
    ...
    image: "https://images.pexels.com/photos/3875226/pexels-photo-3875226.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop",
    description: "Johnson's Baby Milk Lotion is clinically proven to be mild and gentle for delicate baby skin. Enriched with milk proteins, it moisturises and softens baby's skin all day.",
    rating: 4.7,
    reviewCount: 6120,
    inStock: true
  },
  // ─── RICE & DAL (12 products) ───────────────────────────────────────────────
  {
    ...
    image: "https://images.pexels.com/photos/4110251/pexels-photo-4110251.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop",
    description: "India Gate Classic Basmati Rice is known for its long, slender grains and distinctive aroma. Aged for 24 months for perfect elongation and a fluffy, non-sticky texture.",
    rating: 4.6,
    reviewCount: 6720,
    inStock: true
  },
  {
    ...
    image: "https://images.pexels.com/photos/724220/pexels-photo-724220.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop",
    description: "Daawat Super Basmati Rice features extra-long grains that elongate beautifully when cooked. The natural aroma and taste make it perfect for biryani and pulao dishes.",
    rating: 4.5,
    reviewCount: 4350,
    inStock: true
  },
  {
    ...
    image: "https://images.pexels.com/photos/4110253/pexels-photo-4110253.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop",
    description: "BB Royal Sona Masoori Raw Rice is a premium medium-grain rice known for its soft texture and slightly sweet taste. Perfect for everyday cooking, idli, and dosa batter.",
    rating: 4.4,
    reviewCount: 2760,
    inStock: true
  },
  {
    ...
    image: "https://images.pexels.com/photos/6260921/pexels-photo-6260921.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop",
    description: "Fortune Toor Dal is carefully cleaned and processed to retain its natural nutrients. These golden split pigeon peas cook quickly and are perfect for everyday dal and sambar.",
    rating: 4.4,
    reviewCount: 3102,
    inStock: true
  },
  {
    ...
    image: "https://images.pexels.com/photos/6260922/pexels-photo-6260922.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop",
    description: "24 Mantra Organic Moong Dal is sourced from certified organic farms. Rich in protein and easy to digest, these split green gram lentils are ideal for khichdi and soups.",
    rating: 4.5,
    reviewCount: 1540,
    inStock: true
  },
  {
    ...
    image: "https://images.pexels.com/photos/7421250/pexels-photo-7421250.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop",
    description: "Tata Sampann Chana Dal is unpolished to retain natural goodness and nutrients. Split Bengal gram with earthy flavour, ideal for dal, halwa, and chaat recipes.",
    rating: 4.3,
    reviewCount: 876,
    inStock: true
  },
  {
    ...
    image: "https://images.pexels.com/photos/7421252/pexels-photo-7421252.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop",
    description: "Patanjali Red Masoor Dal is naturally grown and minimally processed. These red lentils cook quickly without soaking and are rich in iron, protein, and fibre.",
    rating: 4.2,
    reviewCount: 654,
    inStock: true
  },
  {
    ...
    image: "https://images.pexels.com/photos/6261128/pexels-photo-6261128.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop",
    description: "Tata Sampann Urad Dal Black is carefully processed whole black gram. Rich in protein and fibre, it's the main ingredient in dal makhani, idli, and dosa batter.",
    rating: 4.3,
    reviewCount: 1230,
    inStock: true
  },
  {
    ...
    image: "https://images.pexels.com/photos/6544376/pexels-photo-6544376.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop",
    description: "Rajdhani Besan is milled from premium quality chickpeas for a fine, smooth texture. Essential for pakoras, dhokla, kadhi, and a variety of Indian sweets.",
    rating: 4.4,
    reviewCount: 2100,
    inStock: true
  },
  {
    ...
    description: "Aashirvaad Whole Wheat Atta is made from 100% whole wheat grains, ground to perfection. Makes soft, nutritious rotis that are rich in fibre and essential nutrients.",
    rating: 4.6,
    reviewCount: 8910,
    inStock: true
  },
  {
    ...
    image: "https://images.pexels.com/photos/4117553/pexels-photo-4117553.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop",
    description: "Fortune Sunlite Refined Sunflower Oil is light, clear, and virtually odourless. High in Vitamin E and low in saturated fats, it's ideal for everyday cooking and frying.",
    rating: 4.3,
    reviewCount: 3120,
    inStock: true
  },
  {
    ...
    image: "https://images.pexels.com/photos/6261130/pexels-photo-6261130.jpeg?auto=compress&cs=tinysrgb&w=400&h=400&fit=crop",
    description: "Premium Red Kidney Beans (Rajma) for the classic Punjabi rajma dish. Thick-skinned with a meaty texture, these beans hold their shape when cooked for an authentic taste.",
    rating: 4.4,
    reviewCount: 1870,
    inStock: true
  }
...
function LoginModal({ isOpen, onClose, onLoginSuccess }) {
  ...
  const handleOtpChange = (index2, value) => {
    if (!/^[0-9]?$/.test(value)) return;
    const next = [...otp];
    next[index2] = value;
    setOtp(next);
    if (value && index2 < 5) {
      const nextInput = document.getElementById(`otp-${index2 + 1}`);
      nextInput == null ? void 0 : nextInput.focus();
    }
  };
  const handleOtpKeyDown = (index2, e) => {
    if (e.key === "Backspace" && !otp[index2] && index2 > 0) {
      const prev = document.getElementById(`otp-${index2 - 1}`);
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "dialog",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-primary px-6 pt-6 pb-5 text-center", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center gap-1.5 mb-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Zap, { className: "w-6 h-6 text-yellow-300 fill-yellow-300" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary-foreground font-extrabold text-2xl tracking-tight leading-none", children: "QuickCart" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-primary-foreground/80 text-sm font-medium mt-1", children: "India's Fastest Grocery App" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-primary-foreground/60 text-xs mt-0.5", children: "Delivered in 10 minutes ⚡" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-6 py-6", children: [
              step === "phone" ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground font-semibold text-base mb-4", children: "Login or Sign Up" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex rounded-xl border-2 border-input focus-within:border-primary overflow-hidden mb-4 transition-colors", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 px-3 bg-muted border-r border-border", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-base", children: "🇮🇳" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-semibold text-foreground", children: "+91" })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "input",
                    {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 my-4", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground font-medium", children: "or continue with" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 h-px bg-border" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "button",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-4", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground font-semibold text-sm", children: "Enter OTP" }),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2 mb-5 justify-center", children: ["p0", "p1", "p2", "p3", "p4", "p5"].map((pos, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "input",
                  {
                    id: `otp-${i}`,
                    type: "text",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-center text-[11px] text-muted-foreground mt-4 leading-relaxed", children: [
...
function Header({ searchQuery, onSearchChange }) {
  ...
  const [placeholderIndex, setPlaceholderIndex] = reactExports.useState(0);
  const [placeholderVisible, setPlaceholderVisible] = reactExports.useState(true);
  const [searchFocused, setSearchFocused] = reactExports.useState(false);
  const [searchResults, setSearchResults] = reactExports.useState([]);
  const [selectedLocation, setSelectedLocation] = reactExports.useState("Mumbai");
  ...
  reactExports.useEffect(() => {
    if (searchQuery.trim().length >= 1) {
      ...
      const results = products.filter(
        (p) => {
          var _a3, _b2;
          return p.name.toLowerCase().includes(q) || ((_a3 = p.brand) == null ? void 0 : _a3.toLowerCase().includes(q)) || ((_b2 = p.category) == null ? void 0 : _b2.toLowerCase().includes(q));
        }
      ).slice(0, 8);
  ...
  const handleOutsideClick = reactExports.useCallback((e) => {
  ...
  const handleMapBackdropClick = (e) => {
    if (e.target === e.currentTarget) setMapOpen(false);
  };
  const showDropdown = searchFocused && (searchQuery.trim().length > 0 ? searchResults.length > 0 : false);
  const avatarLetter = ((_a2 = userProfile == null ? void 0 : userProfile.phone) == null ? void 0 : _a2.charAt(0)) ?? "U";
  const mapImageUrl = "https://images.unsplash.com/photo-1569336415962-a4bd9f69cd83?w=600&h=300&fit=crop&q=80";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "header",
      {
        ...
        "data-ocid": "header",
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-[1400px] mx-auto px-3 md:px-5 h-16 flex items-center gap-3 md:gap-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "a",
              {
                href: "/",
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-0.5", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Zap, { className: "w-5 h-5 text-yellow-300 fill-yellow-300" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary-foreground font-extrabold text-xl tracking-tight", children: "QuickCart" })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary-foreground/70 text-[10px] font-medium tracking-wide leading-none pl-5", children: "10 min delivery" })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "w-4 h-4 flex-shrink-0 text-yellow-300" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "truncate max-w-[120px]", children: selectedLocation }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronDown, { className: "w-3.5 h-3.5 flex-shrink-0" })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex items-center", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Search, { className: "absolute left-3.5 w-4 h-4 text-muted-foreground pointer-events-none z-10" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "input",
                      {
                        type: "text",
                    ...
                    !searchFocused && !searchQuery && /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "span",
                      {
                        className: `absolute left-10 text-sm text-muted-foreground pointer-events-none select-none transition-opacity duration-300 ${placeholderVisible ? "opacity-100" : "opacity-0"}`,
                        children: SEARCH_PLACEHOLDERS[placeholderIndex]
                      }
                    ),
                  ...
                  showDropdown && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute top-full left-0 right-0 mt-1.5 bg-card rounded-xl shadow-xl border border-border z-50 overflow-hidden max-h-[420px] overflow-y-auto", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "px-4 pt-3 pb-1 text-xs font-semibold text-muted-foreground uppercase tracking-wide", children: "Search Results" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { children: searchResults.map((product) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "button",
                      {
                        type: "button",
                        onClick: () => {
                        ...
                        children: [
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                            ...
                            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: product.weight })
                          ] }),
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-right flex-shrink-0", children: [
                            ...
                            product.discount > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "badge-discount", children: product.discountLabel })
                          ] })
                        ]
                      }
                    ) }, product.id)) })
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-shrink-0 flex items-center gap-2", children: [
              isLoggedIn && userProfile ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref: profileRef, className: "relative hidden md:block", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "button",
                  {
                    type: "button",
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-6 h-6 rounded-full bg-primary-foreground text-primary text-xs font-extrabold flex items-center justify-center", children: avatarLetter }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "max-w-[80px] truncate", children: userProfile.phone }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        ChevronDown,
                        {
                ...
                profileOpen && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 py-3 border-b border-border bg-muted/40", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Logged in as" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm font-bold text-foreground", children: [
                          "+91 ",
                          userProfile.phone
                        ] })
                      ] }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "py-1", children: [
                        [
                          {
                            icon: User,
                            label: "My Profile",
                        ...
                        ].map(({ icon: Icon2, label, ocid }) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                          "button",
                          {
                            type: "button",
                            ...
                            children: [
                              /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { className: "w-4 h-4 text-muted-foreground" }),
                              label
                            ]
                          }
                        ) }, label)),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "my-1 border-t border-border" }) }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden sm:inline", children: "My Cart" }),
                    totalItems > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "bg-accent text-accent-foreground text-[11px] font-extrabold px-1.5 py-0.5 rounded-full leading-none min-w-[20px] text-center", children: totalItems })
                  ]
                }
              )
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:hidden px-3 pb-2.5", "data-ocid": "mobile-search", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref: searchRef, className: "relative", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Search, { className: "absolute left-3.5 top-1/2 -translate-y-1/2 w-4 h-4 text-muted-foreground pointer-events-none z-10" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
              {
                type: "text",
    ...
    mapOpen && /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
          ...
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-5 py-4 border-b border-border", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-base font-bold text-foreground", children: "Deliver to" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5", children: "Select your delivery location" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-full h-44 bg-muted overflow-hidden", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "img",
                  {
                    src: mapImageUrl,
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-primary/10" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "w-8 h-8 text-primary drop-shadow-lg" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "mt-1 bg-card text-foreground text-xs font-bold px-2 py-0.5 rounded-full shadow-md", children: selectedLocation })
                ] }) })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-5 pt-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 px-3 h-10 rounded-xl border-2 border-input focus-within:border-primary bg-background transition-colors", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-5 py-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold text-muted-foreground uppercase tracking-wide mb-3", children: "Popular Cities" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-2", children: MAP_CITIES.map((city) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "button",
                  {
                    type: "button",
                    onClick: () => handleMapCitySelect(city.name),
                    className: `flex items-center gap-2 px-3 py-2.5 rounded-xl border text-sm font-medium transition-smooth ${selectedLocation === city.name ? "border-primary bg-primary/5 text-primary" : "border-border text-foreground hover:border-primary/50 hover:bg-muted"}`,
...
const SLIDES = [
  {
    ...
    subtitle: "Handpicked produce delivered within hours of harvest — 100% quality assured",
    cta: "Shop Fresh",
    badge: "🌱 FRESHNESS GUARANTEE",
    highlight: "Free delivery on first order!",
    discount: null,
    gradient: "linear-gradient(135deg, #1a7c3e 0%, #0f5a2b 60%, #0d4a24 100%)",
    accentColor: "#FFD600",
    emoji: "🥦",
    emojiRight: "🍎"
  },
  {
    ...
    subtitle: "Pepsi, Tropicana, Red Bull, Minute Maid & 200+ refreshing choices",
    cta: "Explore Drinks",
    badge: "🧊 CHILLED & READY",
    highlight: "New arrivals every day",
    discount: "20% OFF",
    gradient: "linear-gradient(135deg, #0a4c8c 0%, #062f5e 60%, #041f3d 100%)",
    accentColor: "#FFD600",
    emoji: "🥤",
    emojiRight: "🧃"
  },
  {
    ...
    subtitle: "Kurkure, Lay's, Maggi, Oreo & 500+ brands delivered in 10 minutes",
    cta: "Browse Snacks",
    badge: "🔥 BESTSELLERS",
    highlight: "Trusted by 1Cr+ customers",
    discount: "25% OFF",
    gradient: "linear-gradient(135deg, #c44b00 0%, #8c3300 60%, #6b2500 100%)",
    accentColor: "#FFD600",
    emoji: "🍕",
    emojiRight: "🍿"
  },
  {
    ...
    discount: "30% OFF",
    gradient: "linear-gradient(135deg, #5a1cbf 0%, #3d0e8c 60%, #2d0a6b 100%)",
    accentColor: "#FFD600",
    emoji: "🧹",
    emojiRight: "🧴"
  },
  {
    ...
    subtitle: "Amul, Mother Dairy, Epigamia — fresh milk, eggs & more at your door",
    cta: "Order Dairy",
    badge: "🥛 UP TO 40% OFF",
    highlight: "Same-day delivery available",
    discount: "40% OFF",
    gradient: "linear-gradient(135deg, #b07800 0%, #7a5200 60%, #5c3d00 100%)",
    accentColor: "#FFD600",
    emoji: "🥛",
    emojiRight: "🧀"
  }
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            "aria-live": "polite",
            children: SLIDES.map((slide, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      ...
                      "aria-hidden": "true",
                      children: slide.emojiRight
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative z-10 flex items-center h-full px-8 md:px-14", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-lg", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-flex items-center gap-1.5 bg-white/20 backdrop-blur-sm text-white text-[10px] font-extrabold px-3 py-1 rounded-full mb-2 tracking-widest uppercase", children: slide.badge }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-1", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-xl md:text-4xl font-extrabold leading-tight text-white drop-shadow-sm", children: slide.title }),
                      slide.discount && /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "span",
                        {
                          className: "hidden md:flex items-center justify-center min-w-[68px] min-h-[68px] rounded-full text-xs font-black text-center leading-tight flex-shrink-0 shadow-lg px-2",
                          style: {
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/80 text-xs md:text-sm mb-4 max-w-md", children: slide.subtitle }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden md:block text-white/70 text-xs", children: slide.highlight })
                    ] })
                  ] }) })
                ]
              },
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-3 left-1/2 -translate-x-1/2 flex gap-2 z-20", children: SLIDES.map((s, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
            onClick: () => goTo(i),
...
const GooglePayLogo = () => /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { width: "56", height: "40", viewBox: "0 0 56 40", "aria-hidden": "true", children: [
  /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { width: "56", height: "40", rx: "6", fill: "white" }),
  /* @__PURE__ */ jsxRuntimeExports.jsx("text", { x: "4", y: "28", fontSize: "22", fontWeight: "bold", fill: "#4285F4", children: "G" }),
  /* @__PURE__ */ jsxRuntimeExports.jsx("text", { x: "22", y: "27", fontSize: "13", fontWeight: "600", fill: "#5F6368", children: "Pay" }),
  /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "9", cy: "36", r: "2.5", fill: "#EA4335" }),
  /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "16", cy: "36", r: "2.5", fill: "#FBBC04" }),
  /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "23", cy: "36", r: "2.5", fill: "#34A853" }),
  /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "30", cy: "36", r: "2.5", fill: "#4285F4" })
] });
const PhonePeLogo = () => /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { width: "56", height: "40", viewBox: "0 0 56 40", "aria-hidden": "true", children: [
  /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { width: "56", height: "40", rx: "6", fill: "#5F259F" }),
  /* @__PURE__ */ jsxRuntimeExports.jsx("text", { x: "6", y: "22", fontSize: "16", fontWeight: "bold", fill: "white", children: "Ph" }),
  /* @__PURE__ */ jsxRuntimeExports.jsx("text", { x: "6", y: "36", fontSize: "11", fill: "#E0D4F7", children: "Pe" }),
  /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "44", cy: "16", r: "7", fill: "white", opacity: "0.2" }),
  /* @__PURE__ */ jsxRuntimeExports.jsx("text", { x: "40", y: "20", fontSize: "11", fontWeight: "bold", fill: "white", children: "₹" })
] });
const PaytmLogo = () => /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { width: "56", height: "40", viewBox: "0 0 56 40", "aria-hidden": "true", children: [
  /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { width: "56", height: "40", rx: "6", fill: "#002970" }),
  /* @__PURE__ */ jsxRuntimeExports.jsx("text", { x: "4", y: "18", fontSize: "12", fontWeight: "bold", fill: "#00BAF2", children: "Pay" }),
  /* @__PURE__ */ jsxRuntimeExports.jsx("text", { x: "4", y: "31", fontSize: "12", fontWeight: "bold", fill: "white", children: "tm" }),
  /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { x: "4", y: "34", width: "48", height: "2.5", rx: "1.25", fill: "#00BAF2" })
] });
const BhimLogo = () => /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { width: "56", height: "40", viewBox: "0 0 56 40", "aria-hidden": "true", children: [
  /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { width: "56", height: "40", rx: "6", fill: "#00529C" }),
  /* @__PURE__ */ jsxRuntimeExports.jsx("text", { x: "4", y: "17", fontSize: "10", fontWeight: "bold", fill: "#FF6B00", children: "BHIM" }),
  /* @__PURE__ */ jsxRuntimeExports.jsx("text", { x: "4", y: "29", fontSize: "10", fontWeight: "bold", fill: "white", children: "UPI" }),
  /* @__PURE__ */ jsxRuntimeExports.jsx(
    "path",
    {
...
function UpiAppCard({ upi, isSelected, onSelect }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "button",
    {
      ...
      className: `relative flex flex-col items-center justify-center gap-0 rounded-2xl border-2 transition-all duration-200 focus:outline-none overflow-hidden ${isSelected ? "border-[#7B2FF7] shadow-[0_0_0_3px_rgba(123,47,247,0.18)] scale-[1.03]" : "border-gray-200 hover:border-[#c4a8ff] hover:scale-[1.01]"}`,
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(LogoComponent, {})
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            className: `w-full flex items-center justify-center gap-1 py-1.5 ${isSelected ? "bg-[#f5f0ff]" : "bg-white"}`,
            style: { borderRadius: "0 0 14px 14px" },
            children: [
              isSelected && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[#7B2FF7] text-[10px] font-bold", children: "✓" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
                  className: `text-xs font-bold leading-tight text-center ${isSelected ? "text-[#7B2FF7]" : "text-gray-700"}`,
                  children: upi.label
                }
              )
            ]
...
function PaymentModal({
  ...
  const [selectedMethod, setSelectedMethod] = reactExports.useState("upi");
  const [selectedUpi, setSelectedUpi] = reactExports.useState("googlepay");
  ...
  const [selectedBank, setSelectedBank] = reactExports.useState("");
  ...
  const handlePay = () => {
    ...
    setTimeout(() => {
      ...
      onPaymentSuccess == null ? void 0 : onPaymentSuccess();
    }, 1800);
  };
  const handleOverlayKeyDown = (e) => {
  ...
  const methods = [
    { id: "upi", label: "UPI", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Smartphone, { className: "w-4 h-4" }) },
    { id: "card", label: "Card", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(CreditCard, { className: "w-4 h-4" }) },
    {
      id: "netbanking",
      label: "Net Banking",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fixed inset-0 z-[60] flex items-end sm:items-center justify-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        role: "button",
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg font-extrabold", style: { color: "#1a1a1a" }, children: "Choose Payment Method" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs mt-0.5", style: { color: "#6b7280" }, children: [
                    "Amount to pay:",
                    " ",
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-extrabold", style: { color: "#7B2FF7" }, children: [
                      "₹",
                      grandTotal
                    ] })
                  ] })
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              style: { borderColor: "#e5e7eb" },
              children: methods.map((m) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  type: "button",
                  onClick: () => setSelectedMethod(m.id),
                  className: `flex items-center gap-1.5 px-4 py-3 text-xs font-bold whitespace-nowrap transition-colors flex-1 justify-center ${selectedMethod === m.id ? "border-b-2 text-[#7B2FF7]" : "text-gray-500 hover:text-gray-700"}`,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                selectedMethod === "upi" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold text-gray-500 uppercase tracking-wide", children: "Select UPI App" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-3", children: UPI_OPTIONS.map((upi) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                    UpiAppCard,
                    {
                      upi,
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-3", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold text-gray-500 uppercase tracking-wide mb-2", children: "Or enter UPI ID" }),
                ...
                selectedMethod === "card" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold text-gray-500 uppercase tracking-wide mb-3", children: "Credit / Debit Card" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "label",
                      {
                ...
                selectedMethod === "netbanking" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold text-gray-500 uppercase tracking-wide mb-3", children: "Select Your Bank" }),
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "select",
                      {
                        ...
                        children: [
                          ...
                          BANKS.map((bank) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: bank, children: bank }, bank))
                        ]
                      }
                    ),
                  ...
                  selectedBank && /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      ...
                      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-green-600 text-xs font-semibold", children: [
                ...
                selectedMethod === "cod" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                    {
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-bold", style: { color: "#854d0e" }, children: "Cash on Delivery" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs mt-1", style: { color: "#92400e" }, children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    ...
                    children: isProcessing ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "animate-spin inline-block w-5 h-5 border-2 border-white border-t-transparent rounded-full" }),
                      "Processing..."
                    ] }) : `Pay ₹${grandTotal}`
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-center text-xs mt-2 text-gray-400", children: "🔒 100% Secure & Encrypted Payment" })
              ]
            }
          )
        ]
...
function PaymentSuccessModal({ isOpen, onClose, grandTotal }) {
  ...
  if (!isOpen) return null;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fixed inset-0 z-[70] flex items-center justify-center px-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-black/60 backdrop-blur-sm" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        className: `relative bg-white rounded-3xl shadow-2xl z-10 w-full max-w-sm overflow-hidden transition-all duration-500 ${show ? "opacity-100 scale-100" : "opacity-0 scale-90"}`,
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-6 pt-8 pb-6 flex flex-col items-center text-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                className: `w-20 h-20 rounded-full flex items-center justify-center mb-4 transition-all duration-700 ${show ? "scale-100" : "scale-0"}`,
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "svg",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("title", { children: "Payment success" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "circle",
                        {
                          cx: "26",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm mb-1", style: { color: "#6b7280" }, children: "Your order has been placed." }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                style: { backgroundColor: "#f0fdf4", border: "1px solid #bbf7d0" },
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-green-600 text-sm", children: "⚡" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-bold", style: { color: "#0C831F" }, children: "Estimated delivery: 10 minutes" })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-500 font-semibold uppercase tracking-wide", children: "Order ID" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "p",
                      {
                        className: "text-sm font-extrabold",
                  ...
                  grandTotal && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center mt-2", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-500 font-semibold uppercase tracking-wide", children: "Amount Paid" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "p",
                      {
                        className: "text-sm font-extrabold",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full flex items-center justify-between mb-6 px-2", children: ["Order Placed", "Preparing", "On the way", "Delivered"].map(
              (step, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
...
function StarRating({ rating }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-0.5", children: [1, 2, 3, 4, 5].map((star) => /* @__PURE__ */ jsxRuntimeExports.jsx(
    Star,
    {
      className: `w-3.5 h-3.5 ${star <= Math.round(rating) ? "fill-yellow-400 text-yellow-400" : "fill-gray-200 text-gray-200"}`
    },
    star
  )) });
}
function formatReviewCount$1(count) {
...
function ProductDetailModal({ product, onClose }) {
  ...
  const description = product.description || `${product.name} by ${product.brand} — a trusted choice for quality and freshness. Sourced from the best suppliers, this product is packed to retain maximum freshness and nutritional value. Perfect for everyday household needs.`;
  const handleOverlayKeyDown = (e) => {
    if (e.key === "Escape") onClose == null ? void 0 : onClose();
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fixed inset-0 z-[60] flex items-end sm:items-center justify-center", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-full h-56 sm:h-64 overflow-hidden bg-gray-50", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "img",
              {
                src: product.image,
            ...
            !!product.discount && /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-5 pt-4 pb-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "p",
                    {
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm mt-0.5", style: { color: "#6b7280" }, children: product.weight }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mt-2", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs", style: { color: "#9ca3af" }, children: [
                      formatReviewCount$1(product.reviewCount),
                      " ratings"
                    ] })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-baseline gap-2 mt-3", children: [
                    ...
                    product.originalPrice > product.price && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        "span",
                        {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-5", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm leading-relaxed", style: { color: "#4b5563" }, children: description })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-5 mt-4", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "h3",
                    {
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2", children: HIGHLIGHTS.map((h) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                    {
                  ...
                  "div",
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs", style: { color: "#4ade80" }, children: "QuickCart Express • Available now" })
                      ] })
                    ]
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-5 pb-6", children: qty === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    type: "button",
...
function ProductCard({ product, onProductClick }) {
  ...
  const handleCardKeyDown = (e) => {
    if (e.key === "Enter" || e.key === " ") onProductClick == null ? void 0 : onProductClick(product);
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative h-[150px] md:h-[180px] w-full overflow-hidden bg-muted", children: [
          !!product.discount && /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: qty === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  type: "button",
                  onClick: (e) => {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(Plus, { className: "w-4 h-4 stroke-[3]" })
                }
              ) : /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "button",
                      {
                        ...
                        children: /* @__PURE__ */ jsxRuntimeExports.jsx(Minus, { className: "w-3 h-3 stroke-[3]" })
                      }
                    ),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-bold text-accent-foreground min-w-[1rem] text-center tabular-nums", children: qty }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "button",
                      {
                        type: "button",
                        ...
                        children: /* @__PURE__ */ jsxRuntimeExports.jsx(Plus, { className: "w-3 h-3 stroke-[3]" })
                      }
                    )
                  ]
                }
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-2.5 flex flex-col gap-0.5 flex-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-[13px] font-semibold text-foreground line-clamp-2 leading-snug min-h-[2.6em]", children: product.name }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-muted-foreground font-medium truncate", children: product.weight }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-baseline gap-1.5 mt-1", children: [
            ...
            product.originalPrice > product.price && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[11px] text-muted-foreground line-through", children: [
              "₹",
              product.originalPrice
            ] })
          ] })
...
function ProductSection({
  ...
  if (products2.length === 0) return null;
  const SCROLL_AMOUNT = 600;
  const scrollLeft = () => {
    var _a2;
    (_a2 = scrollRef.current) == null ? void 0 : _a2.scrollBy({ left: -SCROLL_AMOUNT, behavior: "smooth" });
  };
  const scrollRight = () => {
    var _a2;
    (_a2 = scrollRef.current) == null ? void 0 : _a2.scrollBy({ left: SCROLL_AMOUNT, behavior: "smooth" });
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mt-7", "aria-label": title, "data-ocid": "product-section", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-3 px-0.5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-base md:text-[1.15rem] font-extrabold text-foreground tracking-tight", children: title }),
    ...
    layout === "scroll" ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative group/section", children: [
      ...
      showRightArrow && products2.length > 4 && /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          type: "button",
          onClick: scrollRight,
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronRight, { className: "w-5 h-5 text-foreground" })
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          children: products2.map((product) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            ProductCard,
            {
              product,
              onProductClick
...
function ShopByCategory({ onCategorySelect }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2.5 mb-4 px-0.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              className: "w-1 h-5 rounded-full flex-shrink-0",
              style: {
                background: "linear-gradient(180deg, oklch(0.48 0.27 308) 0%, oklch(0.55 0.22 290) 100%)"
              },
              "aria-hidden": "true"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-base md:text-[1.15rem] font-extrabold text-foreground tracking-tight", children: "Shop By Category" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-5 md:grid-cols-10 gap-2.5 md:gap-3", children: SHOP_BY_CATEGORY.map((cat, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            type: "button",
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block w-full aspect-square overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                "img",
                {
                  src: cat.img,
                  alt: cat.label,
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] md:text-xs font-bold text-foreground text-center leading-tight line-clamp-2 py-1.5 px-1 w-full", children: cat.label })
            ]
          },
          `${cat.id}-${idx}`
        )) })
...
function AppContent() {
  ...
  const [paymentSuccessOpen, setPaymentSuccessOpen] = reactExports.useState(false);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background flex flex-col", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Header, { searchQuery, onSearchChange: setSearchQuery }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      CategoryTabs,
      {
        categories,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "flex-1 max-w-[1400px] mx-auto w-full px-3 md:px-6 pb-12", children: searchQuery ? /* @__PURE__ */ jsxRuntimeExports.jsx(
      ProductSection,
      {
      ...
      ProductSection,
      {
        title: ((_a2 = categories.find((c) => c.id === activeCategory)) == null ? void 0 : _a2.name) ?? "Products",
        products: filteredProducts,
        layout: "grid",
        onProductClick: setSelectedProduct
      }
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(ShopByCategory, { onCategorySelect: handleCategorySelect }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        ProductSection,
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        ...
        {
          title: "🔥 Bestsellers",
          products: [...products].sort((a, b) => (b.reviewCount ?? 0) - (a.reviewCount ?? 0)).slice(0, 12),
          layout: "scroll",
          onViewAll: () => handleCategorySelect("all"),
          onProductClick: setSelectedProduct
        }
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(CartSidebar, { onProceedToPayment: handleProceedToPayment }),
...
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(CartProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(AppContent, {}) });
}
